...
class SignupForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['email'].widget.attrs.update({
            'class': 'form-control col-sm-10',
            'placeholder': 'ex) upc_sw1004@naver.com / 아이디, 비밀번호 찾기에 이용됩니다.',
        })
    ...
    class Meta:
        model = User
        fields = UserCreationForm.Meta.fields + ('email', 'policy_check')
...
class IdFindForm(PasswordResetForm):
    ...
    def save(self, domain_override=None, subject='[u.PC] 아이디 찾기 결과입니다.',
