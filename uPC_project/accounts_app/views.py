...
class SignupView(CreateView):
    ...
    def form_valid(self, form):
        ...
        # 회원가입 인증 메일 발송
        send_mail(
            '[u.PC] {}님의 회원가입 인증메일 입니다.'.format(self.object.username),
            [self.object.email],
...
class PasswordChange(PasswordChangeView):
    ...
    def form_valid(self, form):
        ...
        # 패스워드 변경 알림 메일 발송
        send_mail(
            '[u.PC] {}님 방금 패스워드를 변경하셨습니다.'.format(self.request.user.username),
