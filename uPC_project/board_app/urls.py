...
urlpatterns=[
    ...
    path('<str:board_type>/<int:pk>/add_to_scrap/', add_to_scrap,name='add_to_scrap'),
    path('<str:board_type>/<int:pk>/toggle_scrap/', toggle_scrap, name='toggle_scrap'),
    path('<str:board_type>/<int:pk>/check_post__scrap/', check_post_scrap, name='check_post_scrap'),
